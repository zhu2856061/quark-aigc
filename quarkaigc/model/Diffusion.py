...
from quarkaigc.modules.diffusion import UNCONDITIONAL_CONFIG
from quarkaigc.modules.diffusion.wrappers import OPENAIUNETWRAPPER
from quarkaigc.modules.ema import LitEma
...
class DiffusionEngine(pl.LightningModule):
    ...
    def __init__(
        ...
        self.model = get_obj_from_str(
            default(network_wrapper,
                    OPENAIUNETWRAPPER))(model, compile_model=compile_model)
        ...
        self.sampler = (instantiate_from_config(sampler_config)
                        if sampler_config is not None else None)
        ...
        self.loss_fn = (instantiate_from_config(loss_fn_config)
                        if loss_fn_config is not None else None)
    ...
    def configure_optimizers(self):
        ...
        opt = self.instantiate_optimizer_from_config(params, lr,
