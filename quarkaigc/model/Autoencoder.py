...
from quarkaigc.modules.diffusion.model import Encoder, Decoder
...
class AbstractAutoencoder(pl.LightningModule):
    ...
    def init_from_ckpt(
        self, path: str, ignore_keys: Union[Tuple, list,
                                            ListConfig] = tuple()) -> None:
...
class AutoencodingEngine(AbstractAutoencoder):
    ...
    def forward(self,
                x: Any) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
